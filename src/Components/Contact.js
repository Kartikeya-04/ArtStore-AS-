...
const Contact = () => {
  ...
  return (
    <div className="contact-all h-screen">
      <motion.div className="Contacts text-center">
        <div className="2xl:flex xl:flex lg:flex md:flex  sm:block gap-0 sm:mt-[-10px]">
          <motion.div
            className="text-left instagram ml-2 mt-2  cursor-pointer"
            onClick={instt}
          ...
          <motion.div
            className="text-left mr-1 mt-2 twit cursor-pointer sm:text-left"
            onClick={twitter}
            animate={{ rotate: 45, rotate: 90, rotate: 360 }}
            transition={{ duration: 2 }}
          >
          ...
          <motion.div
            className="text-left mt-2 mr-1 whats cursor-pointer sm:text-left"
            onClick={whats}
            animate={{ rotate: 45, rotate: 90, rotate: 360 }}
            transition={{ duration: 2 }}
          >
            ...
            ></i>
            {/* <img src="/whatsapp.svg" height={40} width={40} /> */}
          </motion.div>
        </div>
        <motion.div
          className="p-10 tot"
        ...
        >
          <h1 className="2xl:text-4xl xl:text-4xl lg:text-4xl md:text-4xl font-semibold sm:text-base hover:text-5xl hover:font-bold">
            Contact Us
          </h1>
          <motion.div className=" 2xl:p-6 xl:p-6 lg:p-6 md:p-7 sm:p-2 inss ">
            ...
            <div className="m-6">
              <textarea
                ...
                type="text"
                // style={{ width: '30%' }}
                className="resize-x resize-y textar"
            ...
            >
              <button
                className="rounded-md bg-black text-white p-4 butto hover:p-6"
                onClick={submitt}
              >
                Submit
              </button>
